...
<body>
      ...
      <div class="panel-heading"><center><a href="Menu.php"><button class="btn btn-secondary"><span class="glyphicon glyphicon-chevron-left"></span> Home </button></a><h1>Sales Credit</h1>
      ...
      <br>
      <button class="btn btn-warning" style="width: 150px;" onclick="showSales('Credits')"><span class="glyphicon glyphicon-search"></span> Search</button>
      </center></div>
